...
@NamedQueries({
        @NamedQuery(name = "getAllCategories", query = "select q from CategoryEntity q order by q.categoryName"),

        @NamedQuery(name = "getCategoryById", query = "select q from CategoryEntity q where q.uuid=:categoryUUID"),
